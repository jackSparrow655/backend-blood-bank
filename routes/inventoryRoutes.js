...
//routes
// ADD INVENTORY || POST
router.post("/create-inventory", authMiddelware, isAuthorized("organisation", "hospital"), createInventoryController);

//GET ALL BLOOD RECORDS
router.get("/get-inventory", authMiddelware, isAuthorized("hospital", "organisation"), getInventoryController);
